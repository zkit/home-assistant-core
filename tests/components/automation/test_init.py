...
async def test_reload_single_unchanged_does_not_stop(hass: HomeAssistant, calls):
    """Test that reloading stops any running actions as appropriate."""
    test_entity = "test.entity"
...
async def test_reload_single_add_automation(hass: HomeAssistant, calls):
...
async def test_reload_single_remove_automation(hass: HomeAssistant, calls):
    """Test that reloading a single automation."""
    config1 = {
        automation.DOMAIN: {
            "id": "sun",
